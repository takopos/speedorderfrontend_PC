    ...
    <div class="mainWrap">
      <div class="stepWrap">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item>連鎖分店管理</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      ...
      <div class="inforWrap">
        <div class="nameList">
          <div class="nameItem" >
            <p>使用者名稱:</p>
            <el-input v-model="phone" placeholder="連鎖分店名稱" width="150"></el-input>
          </div>
          <div class="nameItem">
            <p>EMail:</p>
            <el-input v-model="phone" placeholder="統一編號" width="150"></el-input>
          </div>
               <div class="nameItem">
            <p>EMail:</p>
            <el-input v-model="phone" placeholder="速訂ID" width="300"></el-input>
          </div>
        ...
        <div class="formList">
          <el-table :data="tableData" style="width: 100%">
            <el-table-column prop="VendorName" label="店家名稱" width="150"></el-table-column>
            <el-table-column prop="StoreType" label="店家種類" width="150"></el-table-column>
            <el-table-column prop="status" label="狀態" width="200"></el-table-column>
            <el-table-column prop="number" label="統編" width="300"></el-table-column>
            <el-table-column prop="options" fixed="right" label="操作" width="300">
              <template slot-scope="scope2">
                <el-button @click="dialogFormVisible = true" type="text" size="small">檢視</el-button>
   ...
   <div class="setWrap" style="float: right;">
       <el-row type="flex" justify="space-between">
            <el-dialog title="商家審核" :visible.sync="dialogFormVisible">
                <div class="left">
                <el-form :model="form">
                    <el-form-item label="店 家 名 稱  " :label-width="formLabelWidth">
                    <el-input v-model="form.name" autocomplete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="公 司 統 編  " :label-width="formLabelWidth">
                    <el-input v-model="form.region" autocomplete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="單位負責人" :label-width="formLabelWidth">
                    <el-input v-model="form.region" autocomplete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="聯 絡 電 話  " :label-width="formLabelWidth">
                    <el-input v-model="form.region" autocomplete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="電 子 郵 件" :label-width="formLabelWidth">
                    <el-input v-model="form.region" autocomplete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="營業內容描述" :label-width="formLabelWidth">
                        <el-input type="textarea" :rows="3" placeholder="请输入内容" v-model="textarea" maxlength="2000" show-word-limit ></el-input>
                    </el-form-item>
                </el-form>
                </div>
                <div class="right" >
