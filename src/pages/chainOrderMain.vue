            ...
            <el-table-column prop="options" fixed="right" label="操作" width="300">
              <template slot-scope="">
                <el-button @click="dialogFormVisible = true" type="text" size="small"
                  >轉採購單</el-button
                >
                <el-button type="text" size="small" @click="countOver()">結帳作業</el-button>
                <el-button type="text" size="small" @click="dialogOrderVisible=true">訂單明細</el-button>
              </template>
            </el-table-column>
          </el-table>
          <div class="pagesWrap">
      ...
      <el-dialog title="轉採購單" :visible.sync="dialogFormVisible">
        ...
        <el-form :model="form">
          ...
          <div class="formList2">
            ...
            <div class="footerBtn">
              <el-button type="primary" slot="reference" @click="sendOut()">送 出</el-button>
            </div>
          </div>
        </el-form>
      ...
      <el-dialog title="訂單明細" :visible.sync="dialogOrderVisible">
        <div class="leftRightWrap">
          ...
          <div class="rightDialog">
            <el-form :model="form">
              ...
              <el-form-item>
                  <el-button type="primary" @click="dialogOrderVisible = true" style="float:right;">新增商品</el-button>
              </el-form-item>
            </el-form>
          </div>
        </div>
        ...
        <div class="footerContainer footerContainer2">
          ...
          <div class="notesWrap" style="margin-bottom: 50px;">
              ...
              <el-button type="primary" @click="dialogOrderVisible = false">儲 存</el-button>
          </div>
        </div>
      </el-dialog>
    </div>
