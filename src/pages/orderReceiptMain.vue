    ...
    <div class="mainWrap">
      <div class="stepWrap">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item> 電子發票 </el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      <div class="inforWrap">
        <div class="nameList">
        ...
        <div class="formList">
          ...
          <el-table :data="tableData" style="width: 100%">
            <el-table-column prop="kinds" label="訂單編號" width="110"></el-table-column>
            <el-table-column prop="name" label="發票類別" width="110"></el-table-column>
            <el-table-column prop="count" label="發票號碼" width="110"></el-table-column>
            <el-table-column prop="permission" label="狀態" width="110"></el-table-column>
            <el-table-column
              prop="permission"
              label="開立日期"
              width="110"
            ...
            <el-table-column
              ...
              width="110"
            ></el-table-column>
            <el-table-column prop="permission" label="備註" width="200"></el-table-column>
          </el-table>
          <div class="pagesWrap">
            <el-pagination
