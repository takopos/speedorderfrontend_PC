<template>
  <div>
    ...
    <div class="mainWrap">
      <div class="stepWrap">
        <el-breadcrumb separator="/">
          <el-breadcrumb-item>發票設定</el-breadcrumb-item>
          <el-breadcrumb-item> 廠商設定 </el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      ...
      <div class="inforWrap">
        ...
        <div class="formList">
          <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="count" label="加值中心" width="200"></el-table-column>
            <el-table-column
              prop="permission"
              label="加值中心統編"
              width="200"
    ...
    <div class="setWrap">
      <el-dialog title="新增廠商電子發票設定" :visible.sync="dialogFormVisible">
        <div class="left">
          <el-form :model="form">
            ...
            <el-form-item label="加值中心使用者代號(帳號)" :label-width="formLabelWidth">
              <el-input v-model="form.region" autocomplete="off"></el-input>
            </el-form-item>
        ...
        <div class="right">
          <el-form :model="form">
            <el-form-item label="加值中心" :label-width="formLabelWidth">
            ...
            <el-form-item label="APIKEY(金鑰)" :label-width="formLabelWidth">
              <el-input v-model="form.region" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label="加值中心使用者密碼" :label-width="formLabelWidth">
              <el-input v-model="form.region" autocomplete="off"></el-input>
            </el-form-item>
