    ...
    <div class="mainWrap">
      <div class="stepWrap">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item>訊息管理</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      ...
      <div class="inforWrap">
        ...
        <div class="formList">
          <el-table :data="tableData" style="width: 100%">
            <el-table-column prop="kinds" label="訊息來源" width="150"></el-table-column>
            <el-table-column prop="name" label="店家名稱" width="150"></el-table-column>
            <el-table-column prop="count" label="標題" width="200"></el-table-column>
            <el-table-column prop="permission" label="內容" width="200"></el-table-column>
            <el-table-column prop="status" label="建立日期" width="150"></el-table-column>
