    ...
    <div class="mainWrap">
      <div class="stepWrap">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item>  分店特約直購訂單  </el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      ...
      <div class="inforWrap">
        ...
        <div class="formList">
          <el-table :data="tableData" style="width: 100%">
            <el-table-column prop="kinds" label="店家名稱" width="150"></el-table-column>
            <el-table-column prop="name" label="訂單日期" width="100"></el-table-column>
            <el-table-column prop="count" label="訂單編號" width="100"></el-table-column>
            <el-table-column
              prop="permission"
              label="物流單號"
              width="100"
            ...
            <el-table-column prop="status" label="發票號碼" width="100"></el-table-column>
