<template>
  <div>
    ...
    <div class="mainWrap">
      <div class="stepWrap">
        <el-breadcrumb separator="/">
          <el-breadcrumb-item>倉儲管理</el-breadcrumb-item>
          <el-breadcrumb-item>倉儲管理</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      <div class="inforWrap">
        <div class="nameList">
          ...
          <div class="nameItem">
            <el-button type="primary" round @click="getUserList(0)">查 詢</el-button>
            <el-button round @click="dialogFormVisible=true">新增物流資訊</el-button>
          </div>
        </div>
        <div class="formList">
          <el-table :data="tableData" style="width: 100%">
            <el-table-column
              ...
              width="150"
            ></el-table-column>
            <el-table-column prop="Id" label="地址" width="150"></el-table-column>
            <el-table-column
              prop="status"
              label="單位負責人"
              width="200"
            ...
            <el-table-column prop="options" fixed="right" label="操作" width="200">
              <template slot-scope="scope">
                <el-button @click="dialogFormVisible = true" type="text" size="small"
                  >編輯</el-button
                >
                <el-button type="text" size="small" @click="open">刪除</el-button>
              </template>
            </el-table-column>
          </el-table>
          <div class="pagesWrap">
    ...
    <div class="setWrap">
      <el-dialog title="倉儲編輯" :visible.sync="dialogFormVisible">
        <div class="leftRightWrap">
          <div class="leftDialog">
            <el-form :model="form">
              <el-form-item label="倉儲名稱" :label-width="formLabelWidth">
          ...
          <div class="rightDialog">
            <el-form :model="form">
              ...
              <el-form-item label="聯絡人電子信箱" :label-width="formLabelWidth">
                <el-input v-model="form.region" autocomplete="off"></el-input>
              </el-form-item>
            </el-form>
          </div>
