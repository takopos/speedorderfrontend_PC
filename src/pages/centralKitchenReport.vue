    ...
    <div class="mainWrap">
      <div class="stepWrap">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item> 商品訂購報表 </el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      <div class="inforWrap">
        <div class="nameList">
        ...
        <div class="formList">
          ...
          <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="count" label="品項編號" width="200"></el-table-column>
            <el-table-column prop="permission" label="品項" width="200"></el-table-column>
            <el-table-column prop="count" label="品項數量" width="200"></el-table-column>
            <el-table-column prop="count" label="商品備註" width="200"></el-table-column>
            <el-table-column prop="count" label="訂單備註" width="200"></el-table-column>
          </el-table>
          <div class="pagesWrap">
            <el-pagination
              @size-change="handleSizeChange"
