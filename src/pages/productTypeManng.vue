<template>
  <div>
    ...
    <div class="mainWrap">
      <div class="stepWrap">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item> 商品類別管理 </el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      <div class="inforWrap">
        <div class="nameList">
          ...
          <div class="nameItem">
            ...
            <el-button round class="btnItem">新增商品類別</el-button>
            <el-button type="" round >報表下載</el-button>
            <el-button type="" round class="btnItem">報表列印</el-button>
          </div>
        </div>
        <div class="formList">
          <el-table :data="tableData" style="width: 100%">
            <el-table-column prop="kinds" label="商品類別名稱" width="200"></el-table-column>
            <el-table-column prop="count" label="商品類別代碼" width="200"></el-table-column>
    ...
    <!-- 檢視彈窗: -->
    <div class="setWrap">
      <el-dialog title="商品類別編輯" :visible.sync="dialogFormVisible">
        <el-form :model="form">
          <el-form-item label="商品類別名稱" :label-width="formLabelWidth">
            <el-input v-model="form.name" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="商品類別代碼" :label-width="formLabelWidth">
            <el-input v-model="form.name" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="類別倍數" :label-width="formLabelWidth">
            <el-input v-model="form.name" autocomplete="off"></el-input>
          </el-form-item>
